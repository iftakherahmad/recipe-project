package net.therap.recipeproject.bootstrap;

import net.therap.recipeproject.domain.*;
import net.therap.recipeproject.repositories.CategoryRepository;
import net.therap.recipeproject.repositories.RecipeRepository;
import net.therap.recipeproject.repositories.UnitOfMeasureRepository;
